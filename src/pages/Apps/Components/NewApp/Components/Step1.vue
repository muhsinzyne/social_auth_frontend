...
const handleStepOne = async (values: any) => {
  if (values && handleData) handleData(values, 1);
};
</script>
  ...
  >
    ...
    >
      ...
      <div v-else class="grid gap-6 lg:grid-cols-2">
        <div class="pr-6">
          <label for="app_name" class="text-gray-700">Name of your app</label>
          <Field
            type="text"
            id="appName"
            name="appName"
        ...
        <div class="pr-6">
          ...
          <div>
            <ErrorMessage name="organization" class="text-red-600 text-sm" />
          </div>
        </div>
        <div class="max-md:hidden"></div>
        <div>
