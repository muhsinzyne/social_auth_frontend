      ...
      >
        ...
        <div class="flex items-center">
          <button
            ...
            ref="submitButton"
            type="submit"
            class="flex items-center justify-center px-2 py-2 font-medium tracking-wide text-white capitalize transition-colors duration-200 transform bg-blue-600 rounded-md hover:bg-blue-500 focus:outline-none focus:bg-blue-500 w-full"
          >
            Sign In
          </button>
        </div>
